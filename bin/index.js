...
/***/ function(module, exports, __webpack_require__) {
	...
	var _demo = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _husl = __webpack_require__(302);
	
	var husl = _interopRequireWildcard(_husl);
	
	__webpack_require__(305);
	
	var _functionBuilder = __webpack_require__(306);
	
	var _functionBuilder2 = _interopRequireDefault(_functionBuilder);
	...
	var sawtooth = function sawtooth(x) {
	...
	function start() {
	    ...
	    sine1 = new _functionBuilder2.default(function (x) {
	        return Math.sin(x);
	    }).ofPeriod(Math.PI * 2).setRange(0, 1, -1, 1).getFx();
	...
	function mainUpdate(deltaMs) {
	    ...
	    graph.point = graphFunc(function (x) {
	        return sine1(x);
	    }, zoom);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  ...
	  if ((typeof requirejs !== "undefined" && requirejs !== null) && ("function" !== "undefined" && __webpack_require__(304) !== null)) {
...
/***/ function(module, exports) {
	...
	var FunctionBuilder = function () {
	    ...
	    _createClass(FunctionBuilder, [{
	        key: "fMod",
	        value: function fMod(x) {
	            return 1;
	        }
	    }, {
	        key: "phaseMod",
	        value: function phaseMod(x) {
	            return 0;
	        }
	        ...
	        key: "getFx",
	        value: function getFx() {
	            var _this = this;
	
	            var B2 = function B2(x) {
	                return _this.B * _this.fMod(x);
	            };
	            var C2 = function C2(x) {
	                return _this.C + _this.phaseMod(x);
	            };
	        ...
	        key: "setRange",
	        value: function setRange(newMin, newMax) {
	            var oldMin = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
	            var oldMax = arguments.length <= 3 || arguments[3] === undefined ? 1 : arguments[3];
	
	            var newRangeDifference = newMax - newMin;
	            var oldRangeDifference = oldMax - oldMin;
	            var a = 0;
	        ...
	        key: "ofRange",
	        value: function ofRange(min, max) {
	            var rangeDifference = max - min;
	            var a = 0;
	        ...
	        key: "setPhaseShift",
	        value: function setPhaseShift(shiftPeriod) {
	            this.C = -shiftPeriod;
	            return this;
	        }
	        ...
	        key: "setFrequency",
	        value: function setFrequency(frequencyHz) {
	            var oldFrequency = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
	        ...
	        /**
	         * Set the period of this function, in hz (times-per-second). If the input fx
	         * is not frequency 1, then you must specify oldFrequency for the output to be correct.
	         * Frequency and period are inverse representations of the same property. So the following
	         * functions all overwrite each other: ofFrequency, setFrequency, ofPeriod, setPeriod.
	         * Returns FunctionBuilder instance.
	        ...
	        key: "setPeriod",
	        value: function setPeriod(periodMs) {
	            var oldPeriod = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
	        ...
	        key: "ofFrequency",
	        value: function ofFrequency(frequencyHz) {
	            if (frequencyHz == 0) {
	                this.B = 0;
	                return this;
	            }
	        ...
	        key: "ofPeriod",
	        value: function ofPeriod(periodMs) {
	            this.B = periodMs;
	            return this;
	        }
	        ...
	        key: "applyFrequencyModulation",
	        value: function applyFrequencyModulation(modulatorFx) {
	            var carrier = this.fMod;
	            this.fMod = function (x) {
	                return carrier(x) * modulatorFx(x);
	            };
	            return this;
	        }
	        ...
	        key: "setFrequencyModulation",
	        value: function setFrequencyModulation(modulatorFx) {
	        ...
	        key: "applyPhaseShiftModulation",
	        value: function applyPhaseShiftModulation(modulatorFx) {
	            var carrier = this.phaseMod;
	            this.phaseMod = function (x) {
	                return carrier(x) + modulatorFx(x);
	            };
	            return this;
	        }
	        ...
	        key: "setPhaseShiftModulation",
	        value: function setPhaseShiftModulation(modulatorFx) {
